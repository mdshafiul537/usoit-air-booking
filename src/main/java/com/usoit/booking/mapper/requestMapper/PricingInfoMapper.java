...
import com.usoit.booking.models.Payment;
import com.usoit.booking.models.Product;
import com.usoit.booking.models.Traveler;
import com.usoit.booking.models.request.Brand;
import com.usoit.booking.models.request.FlightProduct;
import com.usoit.booking.models.request.FlightSegment;
import com.usoit.booking.models.request.PassengerFlight;
...
public class PricingInfoMapper {
  ...
  private PassengerType mapPassengerType(List<Traveler> travelers) {
    ...
    for (int i = 0; i < travelers.size(); i++) {
    	System.out.println("Passenger Type Each One: "+ travelers.get(i).getPassengerTypeCode());
      passengerType.setCode(travelers.get(i).getPassengerTypeCode());
      
      System.out.println("After Set Passenger Type: "+passengerType.getCode());
    }
    System.out.println("Before Return Passenger Type: "+ passengerType.getCode());
