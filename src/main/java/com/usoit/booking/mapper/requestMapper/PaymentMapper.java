...
import com.usoit.booking.models.FormOfPaymentCash;
import com.usoit.booking.models.FormOfPaymentPaymentCard;
import com.usoit.booking.models.Payment;
import com.usoit.booking.models.PaymentCard;
...
public class PaymentMapper {
	 ...
	 */
	private void mapPaymentCard(FormOfPaymentPaymentCard formOfPaymentPaymentCard, FormOfPayment formOfPayment) {
	...
	private CreditCard mapCreditCard(PaymentCard paymentCard) {
		...
		if (paymentCard != null) {
			...
			try {
				expDate = DatatypeFactory.newInstance().newXMLGregorianCalendar(paymentCard.getExpireDate());
