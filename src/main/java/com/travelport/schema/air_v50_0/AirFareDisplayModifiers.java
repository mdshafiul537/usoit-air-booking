 ...
 *       &lt;sequence&gt;
 *         &lt;element name="TripType" type="{http://www.travelport.com/schema/air_v50_0}typeFareTripType" maxOccurs="3" minOccurs="0"/&gt;
 ...
 *         &lt;element name="FareSearchOption" type="{http://www.travelport.com/schema/air_v50_0}typeFareSearchOption" maxOccurs="5" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class AirFareDisplayModifiers {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the fareSearchOption property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public List<TypeFareSearchOption> getFareSearchOption() {
        if (fareSearchOption == null) {
            fareSearchOption = new ArrayList<TypeFareSearchOption>();
        }
