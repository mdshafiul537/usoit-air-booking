...
public class RailService extends Service {
    ...
    public final static QName SERVICE = new QName("http://www.travelport.com/service/universal_v50_0", "RailService");
    public final static QName RailCreateReservationPort = new QName("http://www.travelport.com/service/universal_v50_0", "RailCreateReservationPort");
    static {
        URL url = null;
        try {
