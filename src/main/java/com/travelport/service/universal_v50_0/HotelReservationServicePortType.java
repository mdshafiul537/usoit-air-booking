 ...
 * 2021-06-13T20:09:03.875+06:00
 * Generated source version: 3.2.1
 * 
 */
@WebService(targetNamespace = "http://www.travelport.com/service/universal_v50_0", name = "HotelReservationServicePortType")
...
public interface HotelReservationServicePortType {
    ...
    @WebMethod
    @WebResult(name = "HotelCreateReservationRsp", targetNamespace = "http://www.travelport.com/schema/universal_v50_0", partName = "result")
    public com.travelport.schema.universal_v50_0.HotelCreateReservationRsp service(
        @WebParam(partName = "parameters", name = "HotelCreateReservationReq", targetNamespace = "http://www.travelport.com/schema/universal_v50_0")
        com.travelport.schema.universal_v50_0.HotelCreateReservationReq parameters
    ) throws HotelFaultMessage, PriceFaultMessage;
}
