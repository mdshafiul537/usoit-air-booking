 ...
 * 2021-06-13T20:08:58.701+06:00
 * Generated source version: 3.2.1
 * 
 */
@WebServiceClient(name = "AirService", 
                  wsdlLocation = "/src/main/resources/wsdl/universal_v50_0/UniversalRecord.wsdl",
                  targetNamespace = "http://www.travelport.com/service/universal_v50_0") 
public class AirService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://www.travelport.com/service/universal_v50_0", "AirService");
    public final static QName AirCreateReservationPort = new QName("http://www.travelport.com/service/universal_v50_0", "AirCreateReservationPort");
    public final static QName AirMerchandisingFulfillmentPort = new QName("http://www.travelport.com/service/universal_v50_0", "AirMerchandisingFulfillmentPort");
    public final static QName AirCancelPort = new QName("http://www.travelport.com/service/universal_v50_0", "AirCancelPort");
    static {
        URL url = null;
        try {
            url = new URL("/src/main/resources/wsdl/universal_v50_0/UniversalRecord.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AirService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "/src/main/resources/wsdl/universal_v50_0/UniversalRecord.wsdl");
        }
        WSDL_LOCATION = url;
    }
